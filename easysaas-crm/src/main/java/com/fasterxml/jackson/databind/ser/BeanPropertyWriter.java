        ...
        implements java.io.Serializable // since 2.6
{
    ...
    public void serializeAsField(Object bean, JsonGenerator gen,
        ...
        if (isBlank(value)) {
            if (_nullSerializer != null) {
                ...
                JsonSerializer<Object> serializerByBean = getNullSerializerByBean(bean);
                serializerByBean.serialize(null, gen, prov);
            }
            return;
        }
    ...
    private JsonSerializer<Object> getNullSerializerByBean(Object bean) {
        if (Objects.nonNull(bean)) {
            JsonSerialize annotation = bean.getClass().getAnnotation(JsonSerialize.class);
            if (Objects.nonNull(annotation)) {
                Class<? extends JsonSerializer> nullsUsing = annotation.nullsUsing();
                if (!nullsUsing.isAssignableFrom(JsonSerializer.None.class)) {
                    try {
                        return nullsUsing.newInstance();
