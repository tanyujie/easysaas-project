...
public class VisitorColSelfController {
	@Autowired
	private VisitorColSelfService service;

	@ApiOperation(value = "查询接口", response = VisitorColSelf.class)
	@ApiImplicitParams({
	...
	@ResponseBody
	public RestResult add(VisitorColSelf bean) {
	...
	@ResponseBody
	public RestResult update(VisitorColSelf bean) {
