package org.easymis.easysaas.gateway.advice;
...
public class GlobalExceptionControllerAdvice {
    ...
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    @ResponseBody
    public RestResult processUnsupportedOperationException(NativeWebRequest request, UnsupportedOperationException e) {
        logger.error("拦截异常", e);
        RestResult restResult = new RestResult();
        restResult.error(e.getMessage());
        return restResult;
